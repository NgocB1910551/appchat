...
public class PostActivity extends AppCompatActivity {
    ...
    private void Post(){
        ...
        user.put(Constants.KEY_TEXT_POST,binding.description.getText().toString());
        user.put(Constants.KEY_IMAGE_POST, encodedImage);
        database.collection(Constants.KEY_COLLECTION_POST)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_POST_ID, documentReference.getId());
                    preferenceManager.putString(Constants.KEY_TEXT_POST, binding.description.getText().toString());
                    preferenceManager.putString(Constants.KEY_IMAGE_POST, encodedImage);
